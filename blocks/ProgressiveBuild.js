...
Block.prototype.process = function () {
	...
	// Add Text Events
	Context.TextEvents.addEvent(0, 'Progressive Build', Context.Phase, Context.Classnum, Context.Blocknum, true);
	Context.TextEvents.addEvent(0, 'Build power and cadence together', Context.Phase, Context.Classnum, Context.Blocknum, true);
